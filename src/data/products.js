...
export const products = [
  ...
  { id: 'minis-box-bag', subcategoryId: 'flowers-minis', name: 'קופסא', description: 'קופסא עם שקית פנימית לתפרחות מיניז', specs: { volume: '10 גרם', material: 'קרטון + שקית אלומיניום', closure: 'פתיחה עליונה' }, tags: ['IMC-GMP'], hasToggle: true, isInternal: false, gallery: { closed: generateGallery('minis-box-bag-closed', 8), open: generateGallery('minis-box-bag-open', 9) } },
  { id: 'minis-box-container', subcategoryId: 'flowers-minis', name: 'קופסא', description: 'קופסא עם מיכל פנימי לתפרחות מיניז', specs: { volume: '10 גרם', material: 'קרטון + מיכל פלסטיק', closure: 'פתיחה עליונה' }, tags: ['IMC-GMP'], hasToggle: true, isInternal: false, gallery: { closed: generateGallery('minis-box-container-closed', 5), open: generateGallery('minis-box-container-open', 6) } },

  // צנצנת
  { id: 'jar-container', subcategoryId: 'jar', name: 'צנצנת', description: 'צנצנת לתפרחות', specs: { volume: '10 גרם', material: 'פלסטיק', closure: 'מכסה בורג' }, tags: ['IMC-GMP'], hasToggle: false, isInternal: true, gallery: null, images: { primary: './images/products/jar-container.png' } },
  ...
  { id: 'preroll-slims-tube', subcategoryId: 'prerolls-05', name: 'תרמיל בודד', description: 'תרמיל ל-2 יחידות מגולגלות 0.5 גרם', specs: { volume: '0.5 גרם × 2', material: 'פלסטיק', closure: 'מכסה' }, tags: ['IMC-GMP'], hasToggle: false, isInternal: true, gallery: null, images: { primary: './images/products/preroll-slims-tube.png' } },
  ...
  // שמן
  { id: 'oil-dropper', subcategoryId: 'oil-products', name: 'בקבוק דרופר', description: 'בקבוק זכוכית כהה עם דרופר', specs: { volume: '10 מ"ל', material: 'זכוכית אמבר', closure: 'דרופר' }, tags: ['UV protection', 'IMC-GMP'], hasToggle: false, isInternal: true, gallery: null, images: { primary: './images/products/oil-dropper.png' } },
  { id: 'oil-box', subcategoryId: 'oil-products', name: 'קופסא', description: 'קופסא לבקבוק שמן', specs: { volume: '10 מ"ל', material: 'קרטון', closure: 'פתיחה עליונה' }, tags: ['IMC-GMP'], hasToggle: false, isInternal: false, gallery: null, images: { primary: './images/products/oil-box.png' } },
  ...
  { id: 'combo-preroll-oil-spritzer', subcategoryId: 'combo-preroll-oil', name: 'שפריצר 5 מ"ל', description: 'שמן עם שפריצר מדוד', specs: { volume: '5 מ"ל', material: 'זכוכית + פלסטיק', closure: 'שפריצר' }, tags: ['IMC-GMP'], hasToggle: false, isInternal: true, gallery: null, images: { primary: './images/products/combo-preroll-oil-spritzer.png' } },
  { id: 'combo-preroll-oil-tray', subcategoryId: 'combo-preroll-oil', name: 'מגשית מגולגלות', description: 'מגשית ל-10 מגולגלות 0.25 גרם', specs: { volume: '0.25 גרם × 10', material: 'פלסטיק + כיסוי אלומיניום', closure: 'כיסוי עליון' }, tags: ['IMC-GMP'], hasToggle: false, isInternal: true, gallery: null, images: { primary: './images/products/combo-preroll-oil-tray.png' } },
