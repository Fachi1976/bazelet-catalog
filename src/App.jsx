  ...
  const renderMainCategories = () => (
    <div className="page-container">
      ...
      <div className="page-subtitle">
        <p>בזלת מחויבת ללקוחותיה ומרחיבה את מגוון פתרונות האריזה, מתפרחות ועד שמנים, כדי לאפשר לכם לבנות פורטפוליו מוצרים מדויק בהתאם לאסטרטגיה המסחרית שלכם.</p>
        <p>האריזות מוצגות ללא מיתוג, לבחירה והתאמה מלאה לצרכי המותג.</p>
        <p>עברו בין הקטגוריות, בחרו את הפתרון המתאים, ופנו אלינו לקבלת הצעת מחיר וליווי מלא בתהליך עד לקבלת המוצר הסופי.</p>
      </div>
            ...
            {currentProduct.specs && (
              <div className="product-specs">
                ...
                <table className="specs-table">
                  <tbody>
                    {['volume', 'dimensions', 'material', 'closure'].map((key) => {
                      const value = currentProduct.specs[key];
                      if (!value) return null;
                      const label = key === 'volume' ? 'מכיל' : key === 'material' ? 'חומר' : key === 'closure' ? 'סגירה' : key === 'dimensions' ? 'מידות' : key;
                      return (
                        <tr key={key}>
    ...
    <div className="app" dir="rtl">
      ...
      <header className="header">
        <div className="header-content">
          <div className="logo" onClick={() => {
            ...
            <img src="./images/bazelet-logo.png" alt="Bazelet" className="logo-img" />
          </div>
      ...
      <footer className="footer">
        <div className="footer-contact">
          <a href="mailto:PACK.COORDINATOR@b-group.co.il">PACK.COORDINATOR@b-group.co.il</a>
          <span className="footer-separator">|</span>
          <a href="tel:054-8259082">054-8259082</a>
          <span className="footer-separator">|</span>
          <a href="https://www.bazelet-pharma.co.il/" target="_blank" rel="noopener noreferrer">www.bazelet-pharma.co.il</a>
        </div>
        <p>© 2026 Bazelet Group | IMC-GMP Certified Cannabis Manufacturer</p>
      </footer>
    </div>
  );
}
